    ...
    return (
        <>
            ...
            <section>
              ...
              <div id = 'photo'>
                <div id='subphoto'><h2 style={{marginLeft: '43%'}}>МОИ ДОСТИЖЕНИЯ</h2></div>
              </div>
            </section>
            <section>
              <div className='section_4'>
                <div className='roditel4'>
                  <div className='my_achievements'>
                    <div className='block_1' style = {{display: "flex",justifyContent: 'center'}}>
                      <img className='block_1_photo block_1_photo_1'  src={kobido} alt=""/>
                      <img className='block_1_photo block_1_photo_2' id='yes' src={limfa} alt=""/>
                      <img className='block_1_photo block_1_photo_3' id='yes' src={bukalniy} alt=""/>
                    </div>
                    <div className='block_2' style = {{display: "flex", marginTop: '1%', justifyContent: 'center' }}>
                        <img style = {{ marginRight: '2%'}} className='block_2_photo block_1_photo_1'   src={photo_fitnes} alt=""/>
